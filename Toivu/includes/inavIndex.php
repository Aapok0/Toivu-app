<?php
    ...
    if($_SESSION['sloggedIn']=="yes"){
        ...
        if ($pos != false) {
            echo("<li class=\"nav__item active\"><a href=\"userAccount.php\"><img class=\"nav-icon\" src=\"images/iconfinder_heartbeat_1608928.png\" alt=\"Profile\"><span>" . $_SESSION['suserName'] . ":n sivu</span></a></li><br />");
            echo("<li class=\"nav__item\"><a href=\"logOutUser.php\"><img class=\"nav-icon\" src=\"images/iconfinder_sign-out_298869.png\" alt=\"Profile\"><span>Uloskirjautuminen</span></a></li><br />");
        }
        else {
            echo("<li class=\"nav__item\"><a href=\"userAccount.php\"><img class=\"nav-icon\" src=\"images/iconfinder_heartbeat_1608928.png\" alt=\"Profile\"><span>" . $_SESSION['suserName'] . ":n sivu</span></a></li><br />");
            echo("<li class=\"nav__item\"><a href=\"logOutUser.php\"><img class=\"nav-icon\" src=\"images/iconfinder_sign-out_298869.png\" alt=\"Profile\"><span>Uloskirjautuminen</span></a></li><br />");
        }
    }
    else {
